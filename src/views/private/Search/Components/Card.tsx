...
export default function Card ({ category }: any) {
  return (
    <article onClick={() => handleClick(category.id)} className={`aspect-square w-full h-full relative rounded-lg bg-[${category.color}] overflow-hidden lg:p-4 p-3 pr-0 cursor-pointer flex justify-between`}>
      <div className='w-1/2'>
